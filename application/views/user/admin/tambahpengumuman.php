            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form class="user" action="<?= base_url('admin/tambahpengumuman'); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <img class="img-fluid img-thumbnail rounded mx-auto d-block" id="imagePreview" src="<?= base_url('uploads/'); ?>img/pengumuman/templateGambar.jpg">
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10 pt-1">
                                <textarea class="form-control" name="isiPengumuman" id="summernote" rows="5" onchange="hideError('isiPengumumanError');"><?= set_value('isiPengumuman'); ?></textarea>
