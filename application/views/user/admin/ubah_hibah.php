        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Ubah Hibah</h1>

                    <!-- DataTables -->
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <?= form_open_multipart('admin/ubahhibah'); ?>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 pt-1">
                                    <?= form_input(array(
                                        ...
                                        'type'          => 'text',
                                        'name'          => 'hibahNama',
                                        'value'         => set_value('hibahNama') != null ? set_value('hibahNama') : $hibah['nama'],
                                ...
                                <div class="col-sm-10 pt-1">
                                    <select class="custom-select form-control" id="hibah-kategori" name="hibahKategori">
                                        <?php foreach ($kategori as $kategori) : ?>
                                            <option value="<?= $kategori['id']; ?>"<?= $hibah['kategori_id'] == $kategori['id'] ? "selected" : "" ?>>
                                                <?= $kategori['nama']; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 pt-1">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="hibahFile" id="fileLabel" style="color: #999;"><?= $hibah['file']; ?></label>
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 pt-1">
                                    <select class="custom-select form-control" id="hibah-status" name="hibahStatus">
                                            <option value="aktif"<?= $hibah['status'] == "aktif" ? "selected" : "" ?>>aktif</option>
                                            <option value="pasif"<?= $hibah['status'] == "pasif" ? "selected" : "" ?>>pasif</option>
                                    </select>
